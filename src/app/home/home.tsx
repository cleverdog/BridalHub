...
export default function Home() {
  ...
  const navigate = useNavigate();
    ...
    dataSources: [
      { type: "PostgreSQL", title: "My PostgreSQL", id: "MyPostgresDataSource" },
    ],
  ...
  return (
		<>
      <div className={classes("row-layout home-container")} style={{ height: '100%' }}>
          <RvRevealView options={dashboardOptions}></RvRevealView>
      </div>
		</>
	);
